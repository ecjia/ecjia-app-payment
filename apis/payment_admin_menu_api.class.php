...
class payment_admin_menu_api extends Component_Event_Api {
	...
	public function call(&$options) {	
		$menus = ecjia_admin::make_admin_menu('payment_manage', '支付管理', '', 8);
		$submenus = array(
			...
			ecjia_admin::make_admin_menu('payment_record', '交易流水记录', RC_Uri::url('payment/admin_payment_record/init'), 2)->add_purview(array('payment_manage')),
		);
