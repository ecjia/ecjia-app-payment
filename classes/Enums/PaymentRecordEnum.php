...
class PaymentRecordEnum extends Enum
{
    ...
    {
        return [
            self::PAYMENT_RECORD_STATUS_WAIT        => __('等待支付'),
            self::PAYMENT_RECORD_STATUS_PAYED       => __('支付完成'),
            self::PAYMENT_RECORD_STATUS_PROGRESS    => __('支付进行中'),
            self::PAYMENT_RECORD_STATUS_FAIL        => __('支付失败'),
            self::PAYMENT_RECORD_STATUS_CANCEL      => __('订单撤消'),
            self::PAYMENT_RECORD_STATUS_REFUND      => __('订单退款'),
        ];
    }
